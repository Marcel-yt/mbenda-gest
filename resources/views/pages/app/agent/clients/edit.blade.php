...
<div class="max-w-3xl mx-auto">
  <div class="bg-white p-6 rounded shadow">
    ...
    <form action="{{ route('clients.update', $client) }}" method="post" class="space-y-4" autocomplete="off" enctype="multipart/form-data">
      @csrf
      @method('patch')
      ...
      <div class="flex items-center gap-3 pt-4">
        <a href="{{ route('clients.show', $client) }}" class="mb-link">Annuler</a>
