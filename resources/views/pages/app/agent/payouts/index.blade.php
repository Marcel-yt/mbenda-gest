...
@section('content')
<div class="space-y-6">
  {{-- Statistiques & filtres adapted from admin view --}}
  ...
  <form id="payout-filters" method="GET" action="{{ route('agent.payouts.index') }}" class="mb-6">
            ...
            <tr class="hover:bg-gradient-to-r hover:from-blue-50/30 hover:to-purple-50/30 transition-all duration-200">
              ...
              <td class="px-5 py-4 text-sm text-right">
                <div class="flex items-center justify-end gap-2">
                  <a href="{{ route('agent.payouts.show',$p->id) }}" 
            ...
            <tr>
              <td colspan="7" class="px-5 py-16">
                <div class="flex flex-col items-center justify-center text-center">
                  ...
                  @if(request('q_client') || request('paid_from') || request('paid_to'))
                  <button type="button" onclick="window.location.href='{{ route('agent.payouts.index') }}'"
