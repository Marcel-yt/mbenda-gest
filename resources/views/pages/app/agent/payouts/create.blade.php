...
<div class="max-w-5xl mx-auto space-y-6">
  ...
  <nav class="flex items-center gap-2 text-sm text-gray-600">
    <a href="{{ route('agent.payouts.index') }}" class="hover:text-blue-600 transition-colors flex items-center gap-1" style="color: var(--mb-primary);">
  ...
  {{-- Confirmation Form --}}
  <form method="POST" action="{{ route('agent.payouts.store') }}" class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
    @csrf
    ...
    <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex items-center justify-between">
      <a href="{{ route('agent.payouts.index') }}" class="mb-link">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
