...
<aside class="hidden lg:flex lg:flex-col w-64 bg-[#274718] text-white h-screen fixed left-0 top-0 shadow-xl">
  ...
  <nav class="px-0 py-4 space-y-1 flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-white/20">
    ...
    <a href="{{ route('agent.payouts.index') }}"
      ...
      <svg class="w-5 h-5 flex-shrink-0 transition-transform group-hover:scale-110" viewBox="0 0 24 24" fill="{{ request()->routeIs('agent.payouts.*') ? 'currentColor' : 'none' }}" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg">
