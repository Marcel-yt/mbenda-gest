...
class PayoutController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('pages.app.agent.payouts.index', compact('payouts','qClient','paidFrom','paidTo'));
    }
    ...
    public function create(?int $tontine = null)
    {
        ...
        if ($tontine) {
            ...
            if (Payout::where('tontine_id', $selected->id)->exists()) {
                return redirect()->route('agent.payouts.index')->with('error','Paiement déjà enregistré pour cette tontine.');
            }
        ...
        return view('pages.app.agent.payouts.create', compact('selected','summary'));
    }
    ...
    public function show(int $id)
    {
        ...
        return view('pages.app.agent.payouts.show', compact('payout'));
    }

    /**
     * Download the receipt PDF from storage/public.
     */
    public function download(int $id)
    {
        ...
        return \Storage::disk('public')->download($rel, 'receipt_'.$payout->id.'.pdf');
    }
}
