...
class PayoutController extends ApiController
{
    ...
    /**
     * GET /api/admin/payouts/summary/{tontine_id}
     * Calcul du récapitulatif avant paiement.
     */
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $viewPath = view()->exists('pages.app.admin.payouts.receipt')
                ? 'pages.app.admin.payouts.receipt'
                : 'pages.app.agent.payouts.receipt';
            ...
            Log::error('API Admin: Erreur génération reçu payout '.$payout->id.' : '.$e->getMessage());
        }
